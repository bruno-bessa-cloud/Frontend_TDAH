      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: string) => setValue("category", parseInt(value) as TaskCategory)}
              >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: string) => setValue("priority", parseInt(value) as TaskPriority)}
              >
                <SelectTrigger className="text-base">
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Tempo Estimado */}
            <div className="space-y-2">
              <Label htmlFor="estimatedMinutes" className="text-base font-semibold flex items-center gap-2">
